...
APP_CSS = r"""
    ...
    .gradio-container {
        background:
            ...
            linear-gradient(180deg, #1a2332 0%, #202d3d 34%, #e8ebef 34%, #f3f4f6 100%) !important;
        color: #111827;
    ...
    .winner-popup {
        ...
        border-radius: 8px;
        background: linear-gradient(135deg, rgba(40, 50, 70, 0.98), rgba(50, 65, 85, 0.96)) !important;
        color: #ffffff;
        box-shadow:
...
with gr.Blocks() as demo:
    ...
    gr.Markdown(
        "This app loads every model listed in `MODEL_SPECS`, runs all inferences on the selected Fashion-MNIST sample, and displays the results side by side."
    )

    gr.HTML(
        """
        <div style="background: linear-gradient(135deg, #1e293b 0%, #334155 50%, #475569 100%); padding: 42px 44px; border-radius: 8px; margin-top: 28px; border: 1px solid rgba(255, 255, 255, 0.16); box-shadow: 0 28px 70px rgba(0, 0, 0, 0.34), inset 0 1px 0 rgba(255, 255, 255, 0.12);">
            <h2 style="margin: 0 0 14px; width: fit-content; color: #ffffff; background: none; font-family: 'Segoe UI', Arial, sans-serif; font-size: 2rem; font-weight: 600; letter-spacing: 0.02em;">Model Training & Implementation</h2>
            <p style="max-width: 760px; margin: 0 0 16px; line-height: 1.55; color: #d7dde8; font-size: 1.05rem; font-family: 'Segoe UI', Arial, sans-serif; letter-spacing: 0.015em;">All models used in this project were <strong style="color: #ffffff; font-weight: 760;">independently implemented and trained by me from scratch</strong> using PyTorch.</p>
            
            <div style="margin-top: 22px;">
                <p style="color: #ffffff; font-size: 0.92rem; font-weight: 700; text-transform: uppercase; letter-spacing: 0.08em; margin-bottom: 14px;">Model Architectures:</p>
                <ul style="margin: 0; padding-left: 20px; font-size: 0.98rem; line-height: 1.8;">
                    <li style="color: #ffffff !important;"><strong style="color: #ffffff;">ANN</strong> — Basic feedforward neural network</li>
                    <li style="color: #ffffff !important;"><strong style="color: #ffffff;">Optimized ANN</strong> — With batch normalization, L2 regularization and dropout</li>
                    <li style="color: #ffffff !important;"><strong style="color: #ffffff;">Hyperparameterized ANN</strong> — Hyperparameter tuning using Optuna and Bayesian optimization across multiple parameter values</li>
                    <li style="color: #ffffff !important;"><strong style="color: #ffffff;">CNN</strong> — Convolutional neural network</li>
                    <li style="color: #ffffff !important;"><strong style="color: #ffffff;">ResNet18</strong> — Implemented and fine-tuned using transfer learning</li>
                </ul>
            </div>

            <div style="margin-top: 24px;">
                <p style="color: #ffffff; font-size: 0.92rem; font-weight: 700; text-transform: uppercase; letter-spacing: 0.08em; margin-bottom: 14px;">Training Code & Repositories:</p>
                <ul style="margin: 0; padding-left: 20px; color: #ffffff; font-size: 0.98rem; line-height: 1.8;">
                    <li><a href="https://github.com/dikshantadlakha/fashion_classifier/blob/main/ann_trained_model/ann.ipynb" style="color: #60a5fa; text-decoration: none; font-weight: 600; transition: color 0.2s ease;">ANN Training Code</a></li>
                    <li><a href="https://github.com/dikshantadlakha/fashion_classifier/blob/main/ann_optimised_model/optimised_ann.ipynb" style="color: #60a5fa; text-decoration: none; font-weight: 600; transition: color 0.2s ease;">Optimized ANN</a></li>
                    <li><a href="https://github.com/dikshantadlakha/fashion_classifier/blob/main/hyperparameterised_ann_model/hyperparameterised_ann.ipynb" style="color: #60a5fa; text-decoration: none; font-weight: 600; transition: color 0.2s ease;">Hyperparameter tuned  ANN</a></li>
                    <li><a href="https://github.com/dikshantadlakha/fashion_classifier/blob/main/cnn/cnn.ipynb" style="color: #60a5fa; text-decoration: none; font-weight: 600; transition: color 0.2s ease;">CNN Implementation</a></li>
                    <li><a href="https://github.com/dikshantadlakha/fashion_classifier/blob/main/transfer_learning/transfer_learning_fashion_mnist_pytorch_gpu.ipynb" style="color: #60a5fa; text-decoration: none; font-weight: 600; transition: color 0.2s ease;">ResNet18 Transfer Learning</a></li>
                </ul>
            </div>

            <p style="margin-top: 22px; color: #cbd5e1; font-size: 0.92rem; line-height: 1.6; font-style: italic;">Each repository includes training pipelines, experiment logs, model weights, and comprehensive performance metrics.</p>
        </div>
        """
    )
